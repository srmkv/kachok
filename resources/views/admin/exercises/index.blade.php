    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                ...
                <a href="{{ route('exercises.import_page') }}"
                    class="btn btn-primary shadow-md mr-2">{{ __('messages.import') }}</a>
                <a href="{{ route('exercises.export') }}"
                    class="btn btn-primary shadow-md mr-2">{{ __('messages.export') }}</a>
            </div>
                ...
                <table class="table table-report -mt-2">
                    <thead>
                        <tr>
                            ...
                            <th class="whitespace-nowrap">{{ __('messages.trigger') }}</th>
                            ...
                            <tr>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <form id="delete-form" action="{{ route('exercise.delete', $exercise) }}"
                                            method="post" class="d-none flex">
                                            @csrf
                                            @method('DELETE')
                                            <a class="flex items-center text-warning mr-3"
                                                href="{{ route('exercise.edit', $exercise->id) }}"> <i
