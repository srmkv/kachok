        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            ...
            <div class="intro-y col-span-12 overflow-auto lg:overflow-visible">
                ...
                <table class="table table-report -mt-2">
                   ...
                   <thead>
                        <tr>
                            <th class="whitespace-nowrap">{{ __('messages.doc_name') }}</th>
                            <th class="whitespace-nowrap">{{ __('messages.doc_opisanie') }}</th>
                            <th class="whitespace-nowrap">{{ __('messages.path') }}</th>
                            ...
                            <tr>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <form id="delete-form" action="{{ route('document.delete', $document) }}"
