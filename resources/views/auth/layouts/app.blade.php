...
<body class="g-sidenav-show  bg-gray-100 {{ (\Request::is('rtl') ? 'rtl' : (Request::is('virtual-reality') ? 'virtual-reality' : '')) }} ">
  ...
  <script>
      function openNav() {
            document.getElementById("sidenav-main").style.transform = "unset";
            document.getElementById("sidenav-main").style.zIndex = "100";
               document.getElementById("sidenav-main").style.background = "#fff";
      }
      function closeNav() {
